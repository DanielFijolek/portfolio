  ...
  return (
    <TabContainer tabName={dict.tabsName.education}>
      {dict.education.map((element, idx) => (
        <div
          className="mt-6 flex flex-col rounded-md bg-violet-900/10 p-4 drop-shadow-glow transition-all duration-300 hover:bg-violet-800/20 hover:drop-shadow-glow focus:bg-violet-800/20 focus:outline-none focus:drop-shadow-glow"
          key={idx}
        >
